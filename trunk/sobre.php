<?php
print"
     <html><head><title>Sobre o Ocomon</title>; 
	 ...
	 <p><ul><li>volume de chamados por período;</li>.
	 ...
	 <p>No início de 2005, os dois sistemas: Ocomon e Invmon foram finalmente 100% integrados ganhando um novo .
	 ...
	 <ul><li>abertura de chamados de suporte por área de competência;</li>.
	 ...
	 <ul><li>cadastro detalhado das informações (configuração) de hardware do equipamento;</li>.
	 ...
	 <p>O Ocomon foi concebido sob a visão de software opensource sob o modelo GPL de licenciamento, .
	 ...
	 <ul><li>Linguagem: PHP versão:4.3x, HTML, CSS, Javascript;</li>.
	 ...
	 <p>Esperamos que o Ocomon possa lhe ser tão útil quanto nos é aqui no .
			<a href='http://www.unilasalle.edu.br' target='_blank'>Unilasalle!</a></p>;
	 <p>Atenciosamente</p><p><a href='mailto:flavio@unilasalle.edu.br'>Flávio Ribeiro</a></p>;		
